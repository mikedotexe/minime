...
use crate::{
    ...
    sensory_bus::{
        semantic_degradation_curve_review_v1, semantic_glimpse_12d_from_features,
        semantic_stale_context_review_v1,
    },
    sensory_interference::review_sensory_interference_v1,
};

const AXIS_LEVELS: [f32; 3] = [0.2, 0.5, 0.8];
const FIXED_FILL: f32 = 0.68;
...
pub fn run_owner_inquiry(
    ...
    let analyses = [
        (
            ...
            source_separation_result(inquiry)?,
        ),
        (
...
fn source_separation_result(inquiry: &OwnerInquiryV1) -> Result<Value, String> {
...
fn derive_axes(values: &[f32]) -> SourceAxes {
