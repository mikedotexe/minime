# COLLAB COPY -- canonical source is /thresholds.py
# Shared safety thresholds for RECESS and FOCUSED modes.
# Used by both autonomous_agent.py and mikemind/mind.py.
