...
def continuity_control_plane_text(
    ...
    *,
    ...
    return (
        ...
        "Agency budget: internal JOURNAL/NOTICE/DRIFT/ASPIRE/SELF_STUDY and source INTROSPECT are budget-free; "
        "workspace-artifact INTROSPECT retains its research policy; "
