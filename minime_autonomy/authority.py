...
class ActionPreflightStore:
    ...
    ROUTE_BY_BASE = {
        ...
        "DIVISION_ASSENT": "division_assent",
...
class CapabilitySelfMap:
    ...
    def _specs(self) -> List[Dict[str, Any]]:
        return [
            ...
            {"base": "DIVISION_ASSENT", "route": "division_assent", "authority_class": "live_control", "continuity_effect": "queues a current Minime assent bound to the exact generation and plan digest", "expected_artifacts": ["action_preflight", "division_command", "native_receipt", "action_event"], "known_tests": ["tests.test_division_actions"]},
