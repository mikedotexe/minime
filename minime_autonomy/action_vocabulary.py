...
ACTIVITY_NEXT_ACTIONS = {"ACTIVITY_FOCUS", "ACTIVITY_STATUS", "END_ACTIVITY_FOCUS",
                         "PARK_ACTIVITY", "RETURN_ACTIVITY", "CHECK_MAILBOX"}
DIVISION_STATUS_NEXT_ACTIONS = {"DIVISION_STATUS"}
DIVISION_CEREMONY_NEXT_ACTIONS = {
    "DIVISION_HOLD",
    "DIVISION_DECLINE",
    "DIVISION_INTENT",
    "DIVISION_ASSENT",
...
AFTERIMAGE_NEXT_ACTIONS = {
    "AFTERIMAGE_LIST", "AFTERIMAGE_OPEN", "AFTERIMAGE_KEEP", "AFTERIMAGE_SHARE", "AFTERIMAGE_CUES",
}
